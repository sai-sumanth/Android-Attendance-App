...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] yearString = new String[] {"first","second","thrid","fourth"};
	private String[] subjectfirstString = new String[] {"SC","MC"};
	private String[] subjectsecondString = new String[] {"GT","CN"};
	private String[] subjectthridString = new String[] {"DS","NS"};
	private String[] subjectfourthString = new String[] {"NS","PS"};

	private String[] subjectFinal = new String[] {"M3","CS","SS","DD","AA","11"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				attendanceSessionBean.setAttendance_session_faculty_id(Integer.parseInt(bean.getFaculty_id()));
