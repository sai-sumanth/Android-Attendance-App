...
public class AddStudentActivity extends Activity {
	...
	Spinner spinnerbranch,spinneryear,spinnersection;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> adapter_section = new ArrayAdapter<String>(this,
				android.R.layout.simple_spinner_item, sectionString);
		adapter_section
				.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		...
		registerButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TextUtils.isEmpty(first_name)) {
					...
					Intent intent =new Intent(AddStudentActivity.this,menustudent.class);
