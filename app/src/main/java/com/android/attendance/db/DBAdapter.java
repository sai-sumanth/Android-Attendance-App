...
public class DBAdapter extends SQLiteOpenHelper {
	...
	public void addFaculty(FacultyBean facultyBean) {
		...
		String query = "INSERT INTO faculty_table (faculty_id,faculty_firstname,faculty_Lastname,faculty_mobilenumber,faculty_address,faculty_username,faculty_password) values ('"+
	...
	public FacultyBean validateFaculty(String userName,String password)
	{
		...
		if(cursor.moveToFirst()) 
		{
				...
				facultyBean.setFaculty_id(cursor.getString(0));
	...
	public void updatefacultyaddress(String facultyId,String address) {
		SQLiteDatabase db = this.getWritableDatabase();

		String query = "UPDATE faculty_table SET faculty_address='"+address+"'WHERE faculty_id='"+facultyId+"'";
	...
	public void updatefacultyphone(String facultyId,String phone) {
		SQLiteDatabase db = this.getWritableDatabase();

		String query = "UPDATE faculty_table SET faculty_mobilenumber='"+phone+"'WHERE faculty_id='"+facultyId+"'";
	...
	public FacultyBean getFacultyById(String facultyId)
	{
		FacultyBean facultyBean = new FacultyBean();
		SQLiteDatabase db = this.getWritableDatabase();
		String query = "SELECT * FROM faculty_table where faculty_id="+facultyId;
		Cursor cursor = db.rawQuery(query, null);
	...
	public void addStudent(StudentBean studentBean) {
		...
		String query = "INSERT INTO student_table (student_id,student_firstname,student_lastname,student_mobilenumber,student_address,student_department,student_class) values ('"+
	...
	public ArrayList<StudentBean> getAllStudent()
	{
		...
		if(cursor.moveToFirst()) 
		{
			do{
				...
				studentBean.setStudent_id(cursor.getString(0));
	...
	public void updatestudentaddress(String studentId,String address) {
		...
		String query = "UPDATE student_table SET student_address='"+address+"'WHERE student_id='"+studentId+"'";
	...
	public void updatestudentphone(String studentId,String phone) {
		SQLiteDatabase db = this.getWritableDatabase();

		String query = "UPDATE student_table SET student_mobilenumber='"+phone+"'WHERE student_id='"+studentId+"'";
